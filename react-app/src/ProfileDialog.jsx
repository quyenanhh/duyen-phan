...
export default function ProfileDialog({ ctx }) {
  const {
    ...
    loggedEmail, loggedPhone, userRole, userRoleLabel, userBranch, staffCode, saveProfile, openSecurity,
        ...
        <div style={{ padding: '20px 24px 0', display: 'flex', flexDirection: 'column', gap: 16 }}>
          <div style={{ display: 'flex', justifyContent: 'center' }}>
            <span style={{ position: 'relative', width: 80, height: 80 }}>
              ...
              <span style={{ position: 'absolute', bottom: 0, right: 0, width: 26, height: 26, borderRadius: 999, background: 'var(--brand)', color: 'var(--text-on-brand)', border: '2px solid var(--surface-card)', display: 'grid', placeItems: 'center' }} title="Đổi ảnh đại diện">
