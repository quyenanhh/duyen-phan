...
export function CartIcon({ size = 16, style }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" {...IconProps} style={style}><circle cx="9" cy="21" r="1" /><circle cx="19" cy="21" r="1" /><path d="M2.5 3h2l2.4 12.4a2 2 0 0 0 2 1.6h8.7a2 2 0 0 0 2-1.6L21.5 7H6" /></svg>;
}

export function CalendarIcon({ size = 16, style }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" {...IconProps} style={style}><rect x="3" y="4" width="18" height="17" rx="2" /><path d="M3 9h18M8 2v4M16 2v4" /></svg>;
}

export function ReceiptIcon({ size = 16, style }) {
  return <svg width={size} height={size} viewBox="0 0 24 24" {...IconProps} style={style}><path d="M6 2h12v19l-3-2-3 2-3-2-3 2Z" /><path d="M9 8h6M9 12h6" /></svg>;
}
